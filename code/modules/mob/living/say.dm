...
GLOBAL_LIST_INIT(department_radio_keys, list(
	...
	RADIO_KEY_WND = RADIO_CHANNEL_WND,
	RADIO_KEY_MONTEGOBAY = RADIO_CHANNEL_MONTEGOBAY,
	RADIO_KEY_BISHOPS = RADIO_CHANNEL_BISHOPS,
	RADIO_KEY_WRIGHTS = RADIO_CHANNEL_WRIGHTS,
	RADIO_KEY_VANGRAFFS = RADIO_CHANNEL_VANGRAFFS,
	RADIO_KEY_NRPD = RADIO_CHANNEL_NRPD,
	RADIO_KEY_NCRCF = RADIO_CHANNEL_NCRCF,
	RADIO_KEY_GOVERNMENT = RADIO_CHANNEL_GOVERNMENT,
