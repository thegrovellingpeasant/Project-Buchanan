...
/obj/item/organ/body_egg/alien_embryo/proc/AttemptGrow(kill_on_sucess=TRUE)
	...
	if(kill_on_sucess) //ITS TOO LATE
		new_xeno.visible_message(span_danger("[new_xeno] bursts out of [owner]!"), span_userdanger("You exit [owner], your previous host."), span_italics("You hear organic matter ripping and tearing!"))
