...
/mob/living/simple_animal/hostile/guardian/beam
	...
	playstyle_string = span_holoparasite("As a <b>lightning</b> type, you have 30% damage reduction, apply lightning chains to targets on attack and have a lightning chain to your summoner. Lightning chains will shock anyone near them.")
