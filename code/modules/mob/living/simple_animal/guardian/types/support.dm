...
/mob/living/simple_animal/hostile/guardian/healer
	...
	playstyle_string = span_holoparasite("As a <b>support</b> type, you have 30% damage reduction and may toggle your basic attacks to a healing mode. In addition, Alt-Clicking on an adjacent object or mob will warp them to your bluespace beacon after a short delay.")
