...
/mob/living/simple_animal/hostile/guardian/dextrous
	...
	playstyle_string = span_holoparasite("As a <b>dextrous</b> type you can hold items, store an item within yourself, and take half damage, but do low damage on attacks. Recalling and leashing will force you to drop unstored items!")
