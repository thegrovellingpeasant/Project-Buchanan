...
/mob/living/simple_animal/hostile/asteroid/gutlunch
	name = "aphid"
	desc = "A species of insect farmed by ants for their milk."
	...
	guaranteed_butcher_results = list(/obj/item/reagent_containers/food/snacks/meat/slab/human/mutant/insect = 2, /obj/item/stack/sheet/sinew = 1)
