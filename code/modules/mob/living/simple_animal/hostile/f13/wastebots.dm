...
/mob/living/simple_animal/hostile/handy/contraband
	name = "Mr. 'andy"
...
/mob/living/simple_animal/hostile/handy/protectron/dam1 // broken display models
	name = "damaged protectron"
	icon = 'icons/fallout/mobs/robots/protectrons.dmi'
	icon_state = "Patribot_Peacekeeper_d"
	icon_living = "Patribot_Peacekeeper_d"
	loot = list(/obj/effect/decal/cleanable/robot_debris,/obj/item/stack/crafting/electronicparts/three,/obj/item/stock_parts/cell/ammo/mfc)
	wander = FALSE
	faction = list("neutral","silicon","dog","hostile","pirate","wastebot","wolf","plants","turret","enclave","ghoul","cazador","supermutant","gecko","slime","radscorpion","skeleton","carp","bs","bighorner")

/mob/living/simple_animal/hostile/handy/protectron/dam2// broken display models
	name = "damaged protectron"
	icon = 'icons/fallout/mobs/robots/protectrons.dmi'
	icon_state = "protectron_trade_dead"
	icon_living = "protectron_trade_dead"
	loot = list(/obj/effect/decal/cleanable/robot_debris,/obj/item/stack/crafting/electronicparts/three,/obj/item/stock_parts/cell/ammo/mfc)
	wander = FALSE
	faction = list("neutral","silicon","dog","hostile","pirate","wastebot","wolf","plants","turret","enclave","ghoul","cazador","supermutant","gecko","slime","radscorpion","skeleton","carp","bs","bighorner")

/mob/living/simple_animal/hostile/handy/protectron/dam3 // broken display models
	name = "damaged protectron"
	icon = 'icons/fallout/mobs/robots/protectrons.dmi'
	icon_state = "protectron_dead"
	icon_living = "protectron_dead"
...
/mob/living/simple_animal/bearacle //Not an actual bear
	...
	emote_hear = list()
	emote_see = list()
	response_help_simple  = "waves"
	response_disarm_simple = "pushes"
	response_harm_simple   = "mauls"
...
/mob/living/simple_animal/endbearacle //Not an actual bear
	name = "The Bearacle"
	desc = "Well-mannered by bear and post apocalyptic human standards, with a deep fatalistic streak."
	icon = 'icons/mob/animal.dmi'
	icon_state = "combatbear"
...
/mob/living/simple_animal/planetarium //Not an actual dog
	name = "Tour Guide"
	...
	mob_biotypes = MOB_ROBOTIC|MOB_INORGANIC
	faction = list("neutral", "silicon", "dog", "hostile", "pirate", "wastebot", "wolf", "plants", "turret", "enclave", "ghoul", "cazador", "supermutant", "gecko", "slime", "radscorpion", "skeleton", "carp", "bs", "bighorner")
	speak = list("Welcome to the REPCONN: Blast Off to the Future!", "The future is bright, and RobCo and REPCONN are bringing us there together!", "The Extravehicular Mobility Unit MKI, seen on the left, saw frequent use by NASA through the 20th century!", "The MKII space suit, designed in collaboration by RobCo and REPCONN continues the proud tradition of American space exploration!", "♫I was strolling on the Moon one day...♫", "*Bzzt* Did you ᵏⁿᵒʷ the Eighties were the first tribe in space?", "Proud partners of Nuka Cola, make sure to see Nuka Girl for your complimentary bottle. And see her in theaters soon!")
	speak_emote = list()
	emote_hear = list()
	emote_see = list()
