...
/mob/living/simple_animal/hostile/gecko/firegecko
	var/poison_per_bite = 1
	var/poison_type = /datum/reagent/clf3

/mob/living/simple_animal/hostile/gecko/firegecko/AttackingTarget()
	. = ..()
	if(. && isliving(target))
...
/mob/living/simple_animal/hostile/gecko/firegecko
	name = "fire gecko"
	desc = "A large mutated reptile with sharp teeth, and dull, lifeless eyes."
	icon_state = "firegekko"
	icon_living = "firegekko"
	icon_dead = "firegekko_dead"
	health = 50
