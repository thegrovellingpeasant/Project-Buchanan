...
/mob/dead/new_player/proc/new_player_panel()
	...
	var/datum/browser/popup = new(src, "playersetup", "<div align='center'>New Player Options</div>", 250, 280)
...
/mob/dead/new_player/proc/LateChoices()
	...
	if (SSmaptype.maptype == "reno")
		mapjobs = list(EXP_TYPE_CITIZENS, EXP_TYPE_VANGRAFFS, FACTION_WASTES, EXP_TYPE_WRIGHTS, EXP_TYPE_BISHOPS)
	...
	for(var/category in mapjobs)
		...
		if(!dept_dat.len)
			dept_dat += span_warning("No positions open.")
