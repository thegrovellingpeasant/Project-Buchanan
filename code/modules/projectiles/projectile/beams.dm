...
/obj/item/projectile/beam/gamma
	...
	damage_type = "toxin"
	irradiate = 1000 ///makes the gamma gun a real horrific gun to hold
	range = 15
	pass_flags = PASSTABLE | PASSGLASS | PASSGRILLE | PASSCLOSEDTURF
...
/obj/item/projectile/beam/laser/musket/hitscan
	name = "laser bolt"
	damage = 40
...
/obj/item/projectile/f13plasma/plasmacaster/frank
	name = "plasma bolt"
	icon_state = "plasma_clot"
	damage_type = BURN
	damage = 60
...
/obj/item/projectile/f13plasma/pistol/alien
	...
	icon_state = "ion"
	damage = 90 //this should never be spawned in.
	wound_bonus = 100
