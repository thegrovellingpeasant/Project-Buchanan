/obj/item/projectile/bullet/reusable/arrow
	...
	embedding = list(embed_chance=20, fall_chance=60, jostle_chance=3, ignore_throwspeed_threshold=TRUE, pain_stam_pct=0.2, pain_mult=2, jostle_pain_mult=1, rip_time=25, projectile_payload = /obj/item/ammo_casing/caseless/arrow)
...
/obj/item/projectile/bullet/reusable/arrow/bone //extra mob damage
	...
	embedding = list(embed_chance=16, fall_chance=60, jostle_chance=3, ignore_throwspeed_threshold=TRUE, pain_stam_pct=0.2, pain_mult=2, jostle_pain_mult=1, rip_time=25, projectile_payload = /obj/item/ammo_casing/caseless/arrow/bone)
...
/obj/item/projectile/bullet/reusable/arrow/broadhead
	...
	embedding = list(embed_chance=35, fall_chance=60, jostle_chance=3, ignore_throwspeed_threshold=TRUE, pain_stam_pct=0.2, pain_mult=2, jostle_pain_mult=1, rip_time=25, projectile_payload = /obj/item/ammo_casing/caseless/arrow/broadhead)
