...
/obj/item/bodypart/l_arm/attackby(obj/item/W, mob/user, params)
	if(W.get_sharpness())
		...
		user.visible_message("[user] starts cutting meat from \the [src].", span_notice("You start cutting meat from \the [src]..."), span_italics("You hear the sound of a knife rubbing against flesh."))
