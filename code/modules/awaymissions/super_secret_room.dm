...
/obj/item/rupee/proc/on_entered(datum/source, atom/movable/arrived, atom/old_loc, list/atom/old_locs)
	SIGNAL_HANDLER
	if(!istype(arrived))
		return
	INVOKE_ASYNC(src, PROC_REF(put_in_crossers_hands), arrived)
