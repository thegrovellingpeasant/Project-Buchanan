...
/datum/clockwork_rite/proc/build_info() //Constructs the info text of a given rite, based on the vars of the rite
	...
	. += "It has been used [span_inathneq_small("<b>[times_used]</b><span class='brass'> time[times_used != 1 ? "s" : ""], out of <span class='inathneq_small'><b>[limit != INFINITE ? "[limit]" : "infinite"]</b><span class='brass'> available uses.")]"
