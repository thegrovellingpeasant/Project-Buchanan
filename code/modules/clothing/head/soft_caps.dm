...
/obj/item/clothing/head/soft/hatmar
	name = "An Extremely Large Hat"
	desc = "Made with enough cloth to dress a whole family of sharecroppers back home."
	icon_state = "hatmarsoft"
	item_state = "hatmarsoft"
	soft_type = "hatmar"
	dog_fashion = /datum/dog_fashion/head/hatmar
