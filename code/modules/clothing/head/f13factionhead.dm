...
/obj/item/clothing/head/helmet/f13/fiend_reinforced
	...
	icon_state = "fiend"
	item_state = "fiend"
	armor = list("melee" = 20, "bullet" = 25, "laser" = 15, "energy" = 15, "bomb" = 45, "bio" = 40, "rad" = 20, "fire" = 60, "acid" = 20, "wound" = 40)
	flags_inv = HIDEEARS|HIDEHAIR
	slowdown = 0.025
...
/obj/item/clothing/head/beret/ncr_recon_ranger
	...
	armor = list("melee" = 10, "bullet" = 20, "laser" = 15, "energy" = 15, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 40)
	salvage_loot = list(/obj/item/stack/crafting/armor_plate = 2)
...
/obj/item/clothing/head/f13/trailranger
	...
	armor = list("melee" = 10, "bullet" = 20, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 40)
	salvage_loot = list(/obj/item/stack/crafting/armor_plate = 2)
...
/obj/item/clothing/head/f13/ranger
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 40)
	salvage_loot = list(/obj/item/stack/crafting/armor_plate = 2)
...
/obj/item/clothing/head/helmet/f13/ncr/rangercombat/eliteriot
	...
	armor = list("melee" = 30, "bullet" = 40, "laser" = 40, "energy" = 25, "bomb" = 55, "bio" = 60, "rad" = 60, "fire" = 90, "acid" = 20, "wound" = 55)
...
/obj/item/clothing/head/helmet/f13/combat/brotherhood/outcast
	...
	armor = list("melee" = 20, "bullet" = 30, "laser" = 30, "energy" = 22, "bomb" = 55, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 50)
...
/obj/item/clothing/head/f13/town
	...
	item_state = "dethat"
	flags_inv = HIDEHAIR
	armor = list("melee" = 15, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 20, "bio" = 5, "rad" = 0, "fire" = 15, "acid" = 5, "wound" = 30)
...
/obj/item/clothing/head/f13/town/deputy
	...
	armor = list("melee" = 15, "bullet" = 25, "laser" = 20,  "energy" = 35, "bomb" = 30, "bio" = 40, "rad" = 40, "fire" = 50, "acid" = 10, "wound" = 50)
...
/obj/item/clothing/head/f13/town/sheriff
	...
	armor = list("melee" = 15, "bullet" = 30, "laser" = 25,  "energy" = 35, "bomb" = 30, "bio" = 40, "rad" = 40, "fire" = 50, "acid" = 10, "wound" = 50)
...
/obj/item/clothing/head/helmet/f13/deathskull
	...
	armor = list("melee" = 35, "bullet" = 20, "laser" = 20, "energy" = 25, "bomb" = 25, "bio" = 70, "rad" = 65, "fire" = 80, "acid" = 100)

/obj/item/clothing/head/f13/helmet/wayfarer
	armor = list("melee" = 25, "bullet" = 20, "laser" = 20, "energy" = 25, "bomb" = 25, "bio" = 70, "rad" = 65, "fire" = 80, "acid" = 100)
...
/obj/item/clothing/head/helmet/riot/vaultsec
	...
	armor = list("melee" = 35, "bullet" = 30, "laser" = 35, "energy" = 25, "bomb" = 50, "bio" = 40, "rad" = 40, "fire" = 70, "acid" = 40, "wound" = 50)
	slowdown = 0.01
...
/obj/item/clothing/head/helmet/f13/civilians/ncr_police_chief
	...
	armor = list("melee" = 10, "bullet" = 15, "laser" = 10, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 15)
