...
/obj/item/clothing/suit/armored/medium/steelbib/town
	name = "steel breastplate"
	desc = "A steel breastplate inspired by a pre-war design, this one was made locally in Wendover. It uses a stronger steel alloy in it's construction, still heavy though"
