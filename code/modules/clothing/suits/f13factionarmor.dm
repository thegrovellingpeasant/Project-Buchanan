...
/obj/item/clothing/suit/armor/f13/raider
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 10, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 30)
	strip_delay = 40
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/f13/raider/supafly //melee spec
	...
	armor = list("melee" = 20, "bullet" = 10, "laser" = 10, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 30)
	slowdown = 0.01
	icon_state = "supafly"
	item_state = "supafly"
...
/obj/item/clothing/suit/armor/f13/raider/combatduster
	...
	armor = list("melee" = 10, "bullet" = 15, "laser" = 20, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/exile/legexile
	...
	armor = list("melee" = 20, "bullet" = 10, "laser" = 10, "energy" = 20, "bomb" = 40, "bio" = 40, "rad" = 20, "fire" = 60, "acid" = 30, "wound" = 30)
	icon_state = "legexile"
	item_state = "legexile"
...
/obj/item/clothing/suit/armor/f13/raider/raidermetal
	...
	armor = list("melee" = 30, "bullet" = 25, "laser" = 25, "energy" = 30, "bomb" = 30, "bio" = 60, "rad" = 10, "fire" = 30, "acid" = 20, "wound" = 40)
...
/obj/item/clothing/suit/armor/f13/legion/recruit
	...
	armor = list("melee" = 15, "bullet" = 10, "laser" = 5, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 30)
	slowdown = 0.04
...
/obj/item/clothing/suit/armor/f13/legion/recruit/decan
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 5, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/legion/prime
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 40)
...
/obj/item/clothing/suit/armor/f13/legion/prime/decan
	...
	armor = list("melee" = 25, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 40)
...
/obj/item/clothing/suit/armor/f13/legion/orator
	...
	armor = list("melee" = 30, "bullet" = 25, "laser" = 25, "energy" = 15, "bomb" = 30, "bio" = 5, "rad" = 5, "fire" = 35, "acid" = 0, "wound" = 40)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/f13/legion/heavy
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 25, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0, "wound" = 60)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/f13/legion/vet/vexil
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 25, "energy" = 15, "bomb" = 25, "bio" = 50, "rad" = 20, "fire" = 70, "acid" = 0, "wound" = 40)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/f13/legion/venator
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 20, "energy" = 20, "bomb" = 20, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 5)
...
/obj/item/clothing/suit/armor/f13/legion/centurion //good all around
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 35, "energy" = 25, "bomb" = 45, "bio" = 20, "rad" = 20, "fire" = 45, "acid" = 45, "wound" = 60)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/f13/legion/palacent //laser resist spec
	...
	armor = list("melee" = 40, "bullet" = 40, "laser" = 40, "energy" = 35, "bomb" = 35, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 75)
	slowdown = 0.3
...
/obj/item/clothing/suit/armor/f13/legion/rangercent //speed and bullet resist, sacrifices all else
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 25, "bomb" = 35, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0, "wound" = 55)
	slowdown = 0.08
...
/obj/item/clothing/suit/armor/f13/legion/legate
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 50, "bullet" = 50, "laser" = 50, "energy" = 35, "bomb" = 45, "bio" = 60, "rad" = 20, "fire" = 80, "acid" = 0, "wound" = 75)
...
/obj/item/clothing/suit/armor/f13/legion/vet/explorercanada
	...
	armor = list("melee" = 45, "bullet" = 35, "laser" = 15, "energy" = 15, "bomb" = 40, "bio" = 20, "rad" = 20, "fire" = 25, "acid" = 0, "wound" = 40)
	slowdown = 0.03
/*
...
/obj/item/clothing/suit/armor/f13/utilityvest
	...
	icon = 'icons/fallout/clothing/suits_utility.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothes/suit_utility.dmi'
	armor = list("melee" = 5, "bullet" = 5, "laser" = 5, "energy" = 5, "bomb" = 15, "bio" = 10, "rad" = 20, "fire" = 30, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/utilityvest/logisticsofficer //same as his beret
	...
	armor = list("melee" = 5, "bullet" = 5, "laser" = 5, "energy" = 5, "bomb" = 15, "bio" = 10, "rad" = 20, "fire" = 30, "acid" = 0, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/ncrarmor
	...
	body_parts_covered = CHEST|GROIN|ARMS|LEGS
	armor = list("melee" = 20, "bullet" = 20, "laser" = 15, "energy" = 15, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 35)
	slowdown = 0.1
...
/obj/item/clothing/suit/armor/f13/ncrarmor/reserve
	...
	item_state = "ncr_infantry_vest"
	body_parts_covered = CHEST|GROIN|ARMS|LEGS
	armor = list("melee" = 10, "bullet" = 15, "laser" = 10, "energy" = 10, "bomb" = 30, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 35)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/reinforced
	...
	armor = list("melee" = 20, "bullet" = 25, "laser" = 20, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 40)
	slowdown = 0.12
...
/obj/item/clothing/suit/armor/f13/ncrarmor/mantle/reinforced
	...
	armor = list("melee" = 20, "bullet" = 25, "laser" = 25, "energy" = 25, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 40)
	slowdown = 0.12
...
/obj/item/clothing/suit/armor/f13/ncrarmor/mantle/reinforced/trenchraider
	...
	armor = list("melee" = 25, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 35)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/lieutenant
	...
	armor = list("melee" = 25, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 50)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/captain/ncr_officer_coat
	...
	armor = list("melee" = 20, "bullet" = 25, "laser" = 20, "energy" = 20, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 55)
...
/obj/item/clothing/suit/armor/f13/ncrarmor/captain
	...
	armor = list("melee" = 25, "bullet" = 35, "laser" = 25, "energy" = 25, "bomb" = 50, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 40)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/treasurer
...
/obj/item/clothing/suit/toggle/armor/f13/rangerrecon
	...
	armor = list("melee" = 25, "bullet" = 25, "laser" = 30, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 40)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/f13/trailranger
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 20, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 40)
	slowdown = 0.01
...
/obj/item/clothing/suit/armor/f13/headscribe
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 10, "bullet" = 20, "laser" = 35, "energy" = 40, "bomb" = 36, "bio" = 50, "rad" = 69, "fire" = 10, "acid" = 70, "wound" = 30)
...
/obj/item/clothing/suit/f13/scribe
	...
	armor = list("melee" = 10, "bullet" = 15, "laser" = 25, "energy" = 10, "bomb" = 16, "bio" = 100, "rad" = 0, "fire" = 0, "acid" = 0, "wound" = 30)
...
/obj/item/clothing/suit/f13/seniorscribe
	...
	body_parts_covered = CHEST|ARMS|LEGS
	armor = list("melee" = 10, "bullet" = 20, "laser" = 25, "energy" = 10, "bomb" = 16, "bio" = 100, "rad" = 0, "fire" = 0, "acid" = 0, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/combat/brotherhood
	...
	armor = list("melee" = 30, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 30, "bio" = 60, "rad" = 10, "fire" = 30, "acid" = 20, "wound" = 40)
	slowdown = 0.12
...
/obj/item/clothing/suit/armor/f13/combat/brotherhood/senior
	...
	armor = list("melee" = 35, "bullet" = 40, "laser" = 35, "energy" = 22, "bomb" = 55, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 55)
	slowdown = 0.15
...
/obj/item/clothing/suit/armor/f13/town
	...
	body_parts_covered = CHEST|GROIN|LEGS|ARMS
	armor = list("melee" = 5, "bullet" = 10, "laser" = 10,  "energy" = 10, "bomb" = 20, "bio" = 40, "rad" = 40, "fire" = 50, "acid" = 10, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/town/mayor
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 15, "energy" = 15, "bomb" = 25, "bio" = 15, "rad" = 10, "fire" = 15, "acid" = 5, "wound" = 30)
	slowdown = 0.08
...
/obj/item/clothing/suit/armor/f13/town/sheriff
	...
	armor = list("melee" = 25, "bullet" = 30, "laser" = 25,  "energy" = 25, "bomb" = 30, "bio" = 40, "rad" = 40, "fire" = 50, "acid" = 10, "wound" = 40)
	slowdown = 0.12
...
/obj/item/clothing/suit/armor/f13/metalarmor/steelbib/oasis
	...
	armor = list( "melee" = 20, "bullet" = 25, "laser" = 15, "energy" = 15, "bomb" = 20, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 30)
	slowdown = 0.1
	strip_delay = 5
...
/obj/item/clothing/suit/armor/f13/tribe_armor
	...
	armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10, "wound" = 30)
	slowdown = 0.025
...
/obj/item/clothing/suit/armor/f13/lightcloak
	...
	item_state = "lightcloak"
	body_parts_covered = CHEST|GROIN|ARMS|LEGS
	armor = list("melee" = 10, "bullet" = 5, "laser" = 10, "energy" = 25, "bomb" = 25, "bio" = 70, "rad" = 65, "fire" = 80, "acid" = 100, "wound" = 15)
	slowdown = 0.025
...
/obj/item/clothing/suit/f13/police
	...
	armor = list("melee" = 10, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = 20, "bio" = 5, "rad" = 0, "fire" = 15, "acid" = 5, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/enclave/marine
	...
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS
	armor = list("melee" = 30, "bullet" = 40, "laser" = 40, "energy" = 25, "bomb" = 55, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 50)
	slowdown = 0.2
...
/obj/item/clothing/suit/armor/f13/enclavetrenchcoat
	...
	body_parts_covered = CHEST|GROIN|ARMS|LEGS
	armor = list("melee" = 20, "bullet" = 25, "laser" = 25, "energy" = 22, "bomb" = 55, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/environmentalsuit
	...
	armor = list("melee" = 25, "bullet" = 15, "laser" = 45, "energy" = 33, "bomb" = 45, "bio" = 100, "rad" = 100, "fire" = 50, "acid" = 10, "wound" = 40)
	strip_delay = 60
...
/obj/item/clothing/suit/armor/f13/rangercombat/eliteriot
	...
	armor = list("melee" = 35, "bullet" = 40, "laser" = 40, "energy" = 40, "bomb" = 55, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 55)
...
/obj/item/clothing/suit/armor/f13/rangerrig
	...
	armor = list("melee" = 10, "bullet" = 10, "laser" = 5, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 30)
	slowdown = 0.05
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/bulletbelt/ncr
...
/obj/item/clothing/suit/armor/f13/combat/ncr_patrol/scout
	...
	armor = list("melee" = 15, "bullet" = 20, "laser" = 15, "energy" = 20, "bomb" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/salvatores/white_coat
	...
	armor = list("melee" = 15, "bullet" = 20, "laser" = 15, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 30)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/bulletbelt
...
/obj/item/clothing/suit/armor/f13/bishops/blue_trench_coat
	...
	armor = list("melee" = 25, "bullet" = 15, "laser" = 15, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 30)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/bulletbelt
...
/obj/item/clothing/suit/armor/f13/bishops/boss
	...
	armor = list("melee" = 30, "bullet" = 20, "laser" = 20, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 40)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/bulletbelt
...
/obj/item/clothing/suit/armor/f13/wrights/jacket
	...
	armor = list("melee" = 15, "bullet" = 10, "laser" = 20, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 30)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/bulletbelt
...
/obj/item/clothing/suit/armor/f13/wrights/armored_vest
	...
	armor = list("melee" = 10, "bullet" = 25, "laser" = 10, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/wrights/formalcoat
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 40)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets/bulletbelt
...
/obj/item/clothing/suit/armor/f13/civilians/ncr_police_coat
	...
	icon_state = "ahp_suit"
	item_state = "ahp_suit"
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 40) //up to change
...
/obj/item/clothing/suit/armor/f13/civilians/schlimmcoat
	...
	armor = list("melee" = 10, "bullet" = 10, "laser" = 10, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 15) //up to change
...
/obj/item/clothing/suit/armor/f13/reno/bulletproof
	...
	armor = list("melee" = 10, "bullet" = 25, "laser" = 20, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 35) //up to change
	body_parts_covered = CHEST

/obj/item/clothing/suit/armor/f13/reno/bulletproof/lite
	name = "crude concealed kevlar armor"
	armor = list("melee" = 10, "bullet" = 15, "laser" = 10, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/reno/fiftyninthstreet
	...
	armor = list("melee" = 15, "bullet" = 10, "laser" = 15, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 30) //up to change
	body_parts_covered = CHEST
...
/obj/item/clothing/suit/armor/f13/combat/vangraffs
	...
	armor = list("melee" = 25, "bullet" = 30, "laser" = 30, "energy" = 30, "bomb" = 30, "bio" = 60, "rad" = 10, "fire" = 30, "acid" = 20, "wound" = 40)
	slowdown = 0.12
...
/obj/item/clothing/suit/armor/f13/combat/vangraffs/enforcer
	...
	armor = list("melee" = 30, "bullet" = 40, "laser" = 35, "energy" = 35, "bomb" = 35, "bio" = 60, "rad" = 10, "fire" = 30, "acid" = 20, "wound" = 45)
