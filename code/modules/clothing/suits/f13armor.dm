...
/obj/item/clothing/suit/armor/f13/leather_jacket
	...
	armor = list("melee" = 15, "bullet" = 10, "laser" = 10, "energy" = 10, "bomb" = 20, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/leather_jacket/combat
	...
	armor = list("melee" = 20, "bullet" = 15, "laser" = 15, "energy" = 15, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/leather_jacket/combat/coat
	...
	armor = list("melee" = 25, "bullet" = 15, "laser" = 15, "energy" = 15, "bomb" = 45, "bio" = 30, "rad" = 5, "fire" = 50, "acid" = 35, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/kit
	...
	icon_state = "armorkit"
	item_state = "armorkit"
	armor = list("melee" = 10, "bullet" = 5, "laser" = 5, "energy" = 5, "bomb" = 5, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0, "wound" = 0)
	strip_delay = 30
	slowdown = 0.025
...
/obj/item/clothing/suit/armor/f13/leatherarmor
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 10, "energy" = 10, "bomb" = 32, "bio" = 0, "rad" = 10, "fire" = 30, "acid" = 35, "wound" = 30)
	strip_delay = 40
	slowdown = 0.06
...
/obj/item/clothing/suit/armor/f13/leatherarmor/reinforced
	...
	armor = list("melee" = 25, "bullet" = 25, "laser" = 12, "energy" = 12, "bomb" = 20, "bio" = 0, "rad" = 15, "fire" = 40, "acid" = 35, "wound" = 30)
	slowdown = 0.08
...
/obj/item/clothing/suit/armor/f13/metalarmor
	...
	armor = list("melee" = 15, "bullet" = 15, "laser" = 30, "energy" = 15, "bomb" = 30, "bio" = 30, "rad" = 15, "fire" = 60, "acid" = 0, "wound" = 40)
	slowdown = 0.22
	strip_delay = 10
...
/obj/item/clothing/suit/armor/f13/metalarmor/laserproof
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 40, "energy" = 40, "bomb" = 45, "bio" = 30, "rad" = 15, "fire" = 60, "acid" = 0, "wound" = 45)
	slowdown = 0.2
	strip_delay = 10
...
/obj/item/clothing/suit/armor/f13/metalarmor/reinforced
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 35, "energy" = 35, "bomb" = 45, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 40)
	slowdown = 0.25
	strip_delay = 10
...
/obj/item/clothing/suit/armor/f13/metalarmor/steelbib
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 25, "energy" = 15, "bomb" = 20, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 35)
	slowdown = 0.06
	strip_delay = 5
...
/obj/item/clothing/suit/armor/f13/combat/laserproof
	...
	armor = list("melee" = 20, "bullet" = 20, "laser" = 40, "energy" = 40, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 50)
...
/obj/item/clothing/suit/armor/f13/combat/riotpolice
	...
	armor = list("melee" = 40, "bullet" = 30, "laser" = 30, "energy" = 35, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 5, "acid" = 35, "wound" = 45)
	slowdown = 0.15
...
/obj/item/clothing/suit/armor/f13/combat/swat
	...
	icon_state = "armoralt"
	item_state = "armoralt"
	armor = list("melee" = 10, "bullet" = 25, "laser" = 10, "energy" = 10, "bomb" = 40, "bio" = 60, "rad" = 15, "fire" = 60, "acid" = 30, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/combat/environmental
	...
	armor = list("melee" = 20, "bullet" = 30, "laser" = 40,"energy" = 20, "bomb" = 55, "bio" = 70, "rad" = 100, "fire" = 60, "acid" = 50)
	strip_delay = 60
...
/obj/item/clothing/suit/armor/f13/power_armor/t51b
	...
	armor = list("melee" = 60, "bullet" = 60, "laser" = 60, "energy" = 30, "bomb" = 62, "bio" = 100, "rad" = 99, "fire" = 90, "acid" = 40, "wound" = 72)
...
/obj/item/clothing/suit/armor/f13/power_armor/t60
	...
	slowdown = 0.2
	armor = list("melee" = 70, "bullet" = 70, "laser" = 70, "energy" = 70, "bomb" = 82, "bio" = 100, "rad" = 100, "fire" = 95, "acid" = 50, "wound" = 80)
...
/obj/item/clothing/suit/hooded/tribaloutcast
	...
	armor = list("melee" = 15, "bullet" = 10, "laser" = 5, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0, "wound" = 30)
	strip_delay = 40
...
/obj/item/clothing/head/hooded/cloakhood/tribaloutcast
	...
	armor = list("melee" = 10, "bullet" = 5,"laser" = 5, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/tribal
	...
	icon_state = "tribal"
	item_state = "tribal"
	armor = list("melee" = 15, "bullet" = 10,"laser" = 5, "energy" = 5, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 0, "wound" = 30)
	flags_inv = HIDEJUMPSUIT
	strip_delay = 40
	icon = 'icons/fallout/clothing/armored_light.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothes/armor_light.dmi'
...
/obj/item/clothing/suit/armor/f13/chitinarmor
	...
	icon_state = "insect"
	item_state = "insect"
	armor = list("melee" = 20, "bullet" = 10,"laser" = 10, "energy" = 10, "bomb" = 25, "bio" = 70, "rad" = 65, "fire" = 80, "acid" = 100, "wound" = 35)
	flags_inv = HIDEJUMPSUIT
	strip_delay = 40
...
/obj/item/clothing/suit/armor/f13/sulphitearmor
	...
	icon_state = "sulphite"
	item_state = "sulphite"
	armor = list("melee" = 25, "bullet" = 30,"laser" = 30, "energy" = 20, "bomb" = 50, "bio" = 60, "rad" = 10, "fire" = 60, "acid" = 20, "wound" = 45)
	slowdown = 0.20
...
/obj/item/clothing/suit/armor/f13/vaquero
	...
	icon_state = "vaquero"
	item_state = "vaquero"
	armor = list("melee" = 10, "bullet" = 20,"laser" = 10, "energy" = 10, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0, "wound" = 30)
	flags_inv = HIDEJUMPSUIT
...
/obj/item/clothing/suit/armor/light/wastewar
	...
	icon_state = "wastewar"
	item_state = "wastewar"
	armor = list("melee" = 20, "bullet" = 15, "laser" = 15, "energy" = 10, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0, "wound" = 30)
	slowdown = 0.07
...
/obj/item/clothing/suit/armor/f13/slam
	...
	icon_state = "slam"
	item_state = "slam"
	armor = list("melee" = 15, "bullet" = 20,"laser" = 20, "energy" = 0, "bomb" = 10, "bio" = 0, "rad" = 0, "fire" = 0, "acid" = 0, "wound" = 30)
	flags_inv = HIDEJUMPSUIT
	strip_delay = 40
	icon = 'icons/fallout/clothing/armored_medium.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothes/armor_medium.dmi'
...
/obj/item/clothing/suit/armor/f13/battlecoat //Maxson's battlecoat from Fallout 4
	...
	armor = list("melee" = 20, "bullet" = 10,"laser" = 20, "energy" = 20, "bomb" = 30, "bio" = 0, "rad" = 30, "fire" = 30, "acid" = 30, "wound" = 30)
	strip_delay = 30
	icon = 'icons/fallout/clothing/armored_light.dmi'
	mob_overlay_icon = 'icons/fallout/onmob/clothes/armor_light.dmi'
	pocket_storage_component_path = /datum/component/storage/concrete/pockets
...
/obj/item/clothing/suit/armor/f13/USPSbomber
	...
	armor = list("melee" = 15, "bullet" = 10,"laser" = 5, "energy" = 5, "bomb" = 30, "bio" = 0, "rad" = 30, "fire" = 30, "acid" = 30, "wound" = 30)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets
...
/obj/item/clothing/suit/armor/f13/brahmin_leather_duster
	...
	armor = list("melee" = 10, "bullet" = 5, "laser" = 20, "energy" = 20, "bomb" = 35, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10, "wound" = 25)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets
...
/obj/item/clothing/suit/armor/f13/rustedcowboy
	...
	armor = list("melee" = 10, "bullet" = 20,"laser" = 10, "energy" = 10, "bomb" = 15, "bio" = 0, "rad" = 0, "fire" = 30, "acid" = 0, "wound" = 25)
...
/obj/item/clothing/suit/armor/bone
	...
	blood_overlay_type = "armor"
	armor = list("melee" = 30, "bullet" = 5, "laser" = 0, "energy" = 10, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/harpercoat
	...
	armor = list("melee" = 25, "bullet" = 20, "laser" = 25, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 30)
	slowdown = 0.07
...
/obj/item/clothing/suit/armor/f13/shankduster
	...
	armor = list("melee" = 15, "bullet" = 20, "laser" = 25, "energy" = 35, "bomb" = 30, "bio" = 0, "rad" = 0, "fire" = 25, "acid" = 25, "wound" = 30)
	strip_delay = 40
...
/obj/item/clothing/suit/toggle/armor/f13/rangercustomdark
	...
	armor = list("melee" = 20, "bullet" = 25, "laser" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 30)
...
/obj/item/clothing/suit/donor/soldier
	...
	icon_state = "soldier"
	item_state = "soldier"
	armor = list("melee" = 10, "bullet" = 10, "laser" = 5, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 20)
	pocket_storage_component_path = /datum/component/storage/concrete/pockets
...
/obj/item/clothing/suit/armor/f13/rangercombat/degancustom
	...
	armor = list("melee" = 20, "bullet" = 30, "laser" = 25, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0, "wound" = 40)
...
/obj/item/clothing/suit/toggle/armor/f13/cloakranger //Reskinned trail ranger gear
	...
	armor = list("melee" = 10, "bullet" = 5, "laser" = 5, "bio" = 30, "rad" = 20, "fire" = 60, "acid" = 0)
...
/obj/item/clothing/suit/armor/f13/atomzealot
	...
	armor = list("melee" = 25, "bullet" = 25, "laser" = 25, "energy" = 20, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 10, "acid" = 10, "wound" = 30)
...
/obj/item/clothing/suit/armor/f13/mutant/poncho
	...
	armor = list("melee" = 10, "bullet" = 10, "laser" = 5, "energy" = 15, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10, "wound" = 20)
...
/obj/item/clothing/suit/armor/f13/mutant/metal
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 15, "energy" = 10, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10, "wound" = 40)
...
/obj/item/clothing/suit/armor/f13/mutant/metal/reinforced
	...
	armor = list("melee" = 35, "bullet" = 35, "laser" = 40, "energy" = 20, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10, "wound" = 40)
...
/obj/item/clothing/suit/f13/tribal
	...
	icon_state = "tribal"
	item_state = "tribal"
	armor = list("melee" = 15, "bullet" = 20, "laser" = 15, "energy" = 15, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10, "wound" = 30)
	slowdown = 0.05
...
/obj/item/clothing/suit/f13/tribal/light/whitelegs/extra
	name = "White Legs light armour"
	desc = "A small series of tan and khaki armour plates, held in place with a thin bandolier. Commonly worn by members of the White Legs tribe."
...
/obj/item/clothing/suit/f13/tribal/heavy/whitelegs/yaoguai
	...
	armor = list("melee" = 40, "bullet" = 35, "laser" = 30, "energy" = 25, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10, "wound" = 45)
...
/obj/item/clothing/suit/f13/tribal/eighties/blue
	...
	icon_state = "80sarmor"
	item_state = "80sarmor"
	armor = list("melee" = 30, "bullet" = 25, "laser" = 25, "energy" = 10, "bomb" = 50, "bio" = 40, "rad" = 10, "fire" = 60, "acid" = 10, "wound" = 40)
