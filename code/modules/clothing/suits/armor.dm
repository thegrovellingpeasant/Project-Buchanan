...
/obj/item/clothing/suit/armor/vest
	...
	mutantrace_variation = STYLE_DIGITIGRADE|STYLE_NO_ANTHRO_ICON
	armor = list("melee" = 15, "bullet" = 20, "laser" = 15, "energy" = 15, "bomb" = 25, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "wound" = 30)
	slowdown = 0.05
...
/obj/item/clothing/suit/armor/vest/big
	...
	armor = list("melee" = 20, "bullet" = 25, "laser" = 20, "energy" = 20, "bomb" = 50, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "wound" = 40)
	slowdown = 0.18
...
/obj/item/clothing/suit/armor/vest/trench
	...
	armor = list("melee" = 15, "bullet" = 20, "laser" = 15, "energy" = 15, "bomb" = 35, "bio" = 0, "rad" = 0, "fire" = 50, "acid" = 50, "wound" = 30)
	slowdown = 0.05
