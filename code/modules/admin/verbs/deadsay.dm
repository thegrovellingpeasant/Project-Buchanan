/client/proc/dsay(msg as text)
	...
	var/rendered = "<span class='game deadsay'>[span_prefix("DEAD:")] [span_name("[uppertext(holder.rank)]([src.holder.fakekey ? pick(nicknames) : src.key])")] says, [span_message("\"[emoji_parse(msg)]\"")]</span>"
