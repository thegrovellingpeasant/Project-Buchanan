...
/client/proc/admin_call_shuttle()
	...
	SSblackbox.record_feedback("tally", "admin_verb", 1, "Call Plane") //If you are copy-pasting this, ensure the 2nd parameter is unique to the new proc!
...
/client/proc/cmd_admin_toggle_fov()
	...
	if(busy_toggling_fov)
		to_chat(usr, "[span_warning("A previous call of this function is still busy toggling FoV [on_off ? "on" : "off"]. Have some patiece")].")
		return
