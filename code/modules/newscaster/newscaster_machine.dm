GLOBAL_LIST_EMPTY(allCasters)  //coders forgive me i'm editing the icon states to make my printing press work without messing with too much code
...
/obj/machinery/newscaster/update_icon_state()
	if(stat & (NOPOWER|BROKEN))
		icon_state = "base_machine"   // original was "newscaster_off"
	else
		if(GLOB.news_network.wanted_issue.active)
			icon_state = "base_machine" // original was "newscaster_wanted"
		else
			icon_state = "base_machine" //original was "newscaster_normal"

/obj/machinery/newscaster/update_overlays()
	. = ..()

	if(!(stat & (NOPOWER|BROKEN)) && !GLOB.news_network.wanted_issue.active && alert)
		. += "base_machine" // original was "newscaster_alert"
	...
	switch(hp_percent)
		if(75 to 100)
			return
		if(50 to 75)
			. += "base_machine" // original was "crack1"
		if(25 to 50)
			. += "base_machine" // original was "crack2"
		else
			. += "base_machine" // original was "crack3"
