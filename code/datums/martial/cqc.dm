...
/mob/living/carbon/human/proc/CQC_help()
	...
	to_chat(usr, "[span_notice("Slam")]: Disarm Harm. Slam opponent into the ground, knocking them down.")
	...
	to_chat(usr, "[span_notice("Pressure")]: Disarm Disarm Disarm. Decent stamina damage.")
