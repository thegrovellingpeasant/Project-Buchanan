...
/mob/living/carbon/human/proc/berserker_blows_help()
	...
	to_chat(usr, "[span_notice("Gutpunch")]: Harm Harm. Deal additional damage every second punch, with a chance for even more damage!")
	to_chat(usr, "[span_notice("Shoulder Check")]: Harm Disarm. Launch people brutally across rooms, and away from you.")
	to_chat(usr, "[span_notice("Chokeslam")]: Harm  Grab. Chokeslam to the floor. Against prone targets, deal additional stamina damage and disarm them.")
