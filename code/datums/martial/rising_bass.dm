...
/mob/living/carbon/human/proc/rising_bass_help()
	...
	to_chat(usr, "[span_notice("Side Kick")]: Forces opponent to step to the side.")
	to_chat(usr, "[span_notice("Shoulder Flip")]: Disarm Harm Disarm Harm Grab. Flips opponent over your shoulder and stuns.")
	to_chat(usr, "[span_notice("Repulse Punch")]: Harm Disarm Disarm. Slams the opponent far away from you.")
	to_chat(usr, "[span_notice("Foot Smash")]: Harm Harm. Knocks opponent prone, minor damage.")
	to_chat(usr, "[span_notice("Deft Switch")]: Switches the opponent's held item for your own. Most useful with nothing in your hand.")
