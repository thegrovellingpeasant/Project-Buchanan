...
/datum/martial_art/proc/basic_hit(mob/living/carbon/human/A,mob/living/carbon/human/D)
	...
	if(!damage)
		...
		D.visible_message(
			message = span_warning("[A] has attempted to [atk_verb] [D]!"),
			self_message = span_userdanger("[A] has attempted to [atk_verb] [D]!"),
	...
	D.visible_message(
		message = span_danger("[A] has [atk_verb]ed [D]!"),
		self_message = span_userdanger("[A] has [atk_verb]ed [D]!"),
		vision_distance = COMBAT_MESSAGE_RANGE,
	)
	...
	if((D.stat != DEAD) && damage >= A.dna.species.punchstunthreshold)
		D.visible_message(
			message = span_danger("[A] has knocked [D] down!!"), \
			self_message = span_userdanger("[A] has knocked [D] down!"),
		)
