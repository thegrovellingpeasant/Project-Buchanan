...
/datum/dog_fashion/head/hatmar
	name = "Dogmar"
	desc = "An extremely sympathetic and wheelchair bound pup."
	emote_see = list("plays dead.", "surrenders.", "drags themself around by their forepaws.","seems to be plotting something.")
...
/datum/dog_fashion/head/usps
	name = "Courier REAL_NAME"
	emote_see = list("goes postal.","chews on some mail.","makes a delivery on the floor. Ew.")
	desc = "A scrappy USPS dog, hardened by years of playing fetch. Still sometimes chases mailmen."
