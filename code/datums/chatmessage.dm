...
/datum/chatmessage/Destroy()
	if (!isnull(owned_by) && !QDELING(owned_by))
 ...
 * * lifespan - The lifespan of the message in deciseconds
 */
/datum/chatmessage/proc/generate_image(text, atom/movable/target, mob/owner, datum/language/language, list/extra_classes, lifespan)
