...
GLOBAL_LIST_INIT(radiochannels, list(
	...
	RADIO_CHANNEL_WND = FREQ_WND,
	RADIO_CHANNEL_MONTEGOBAY = FREQ_MONTEGOBAY,
	RADIO_CHANNEL_BISHOPS = FREQ_BISHOPS,
	RADIO_CHANNEL_WRIGHTS = FREQ_WRIGHTS,
	RADIO_CHANNEL_VANGRAFFS = FREQ_VANGRAFFS,
	RADIO_CHANNEL_NRPD = FREQ_NRPD,
	RADIO_CHANNEL_NCRCF = FREQ_NCRCF,
	RADIO_CHANNEL_GOVERNMENT = FREQ_GOVERNMENT
...
GLOBAL_LIST_INIT(reverseradiochannels, list(
	...
	"[FREQ_WND]" = RADIO_CHANNEL_WND,
	"[FREQ_MONTEGOBAY]" = RADIO_CHANNEL_MONTEGOBAY,
	"[FREQ_BISHOPS]" = RADIO_CHANNEL_BISHOPS,
	"[FREQ_WRIGHTS]" = RADIO_CHANNEL_WRIGHTS,
