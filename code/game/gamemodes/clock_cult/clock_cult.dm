...
/datum/game_mode/clockwork_cult/proc/greet_servant(mob/M) //Description of their role
	...
	to_chat(M, span_brass("Unlock <b>Script</b> scripture by converting a new servant or when 35kw of power is reached."))
	to_chat(M, span_brass("<b>Application</b> scripture will be unlocked when 50kw of power is reached."))
