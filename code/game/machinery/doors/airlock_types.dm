...
/obj/machinery/door/airlock/clockwork/examine(mob/user)
	...
	switch(construction_state)
		if(GEAR_SECURE)
			. += span_brass("The cogwheel is solidly <b>wrenched</b> to the brass around it.")
		if(GEAR_LOOSE)
			. += span_alloy("The cogwheel has been <i>loosened</i>, but remains <b>connected loosely</b> to the door!")
