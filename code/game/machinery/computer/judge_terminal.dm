/obj/machinery/computer/judge_terminal//TODO:SANITY
	name = "correctional records console"
	desc = "The NCRCF records console, Used to admit and track inmates into the NCRCF."
	icon_screen = "security"
	icon_keyboard = "security_key"
	req_one_access = list(ACCESS_SECURITY, ACCESS_FORENSICS_LOCKERS, ACCESS_NRPD)
...
/obj/machinery/computer/judge_terminal/laptop
...
/obj/machinery/computer/judge_terminal/ui_interact(mob/user)
	. = ..()
	if(isliving(user))
...
What a mess.*/
/obj/machinery/computer/judge_terminal/Topic(href, href_list)
	. = ..()
	if(.)
		return .
...
/obj/machinery/computer/judge_terminal/proc/get_photo(mob/user)
...
/obj/machinery/computer/judge_terminal/proc/print_photo(icon/temp, person_name)
	if (printing)
		return
	printing = TRUE
	sleep(20)
...
/obj/machinery/computer/judge_terminal/emp_act(severity)
	. = ..()
...
/obj/machinery/computer/judge_terminal/proc/canUseSecurityRecordsConsole(mob/user, message1 = 0, record1, record2)
	if(user)
		if(authenticated)
