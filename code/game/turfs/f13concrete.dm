...
/turf/closed/wall/mineral/concrete
	...
	smooth = SMOOTH_TRUE
	sheet_type = /obj/item/stack/sheet/mineral/concrete
	canSmoothWith = list(/turf/closed/wall/f13/supermart,/turf/closed/wall/mineral/concrete,/turf/closed/wall,/turf/closed/wall/mineral/concrete/blastproof, /turf/closed/wall/mineral/concrete/blastproof/moresmooth, /turf/closed/wall/mineral/concrete/blastproof/storewall)
