...
/obj/structure/on_attack_hand(mob/user, act_intent = user.a_intent, unarmed_attack_flags)
	...
	if(structureclimber && structureclimber != user)
		...
		structureclimber.visible_message(
			message = span_warning("[structureclimber] has been knocked off [src]."),
			self_message = "You're knocked off [src]!",
			blind_message = "You hear [structureclimber] get knocked off [src].",
		)
