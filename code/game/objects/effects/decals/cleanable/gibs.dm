...
/obj/effect/decal/cleanable/blood/gibs/on_entered(datum/source, atom/movable/arrived, atom/old_loc, list/atom/old_locs)
	if(isliving(arrived) && has_gravity(loc))
		playsound(loc, 'sound/effects/gib_step.ogg', HAS_TRAIT(arrived, TRAIT_LIGHT_STEP) ? 20 : 50, TRUE)
	. = ..()
