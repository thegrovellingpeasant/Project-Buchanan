...
/obj/item/radio/headset/headset_montegobay
	name = "staff radio headset"
	desc = "This is used by the staff of the Montego Bay.\nTo access the staff channel, use :i. \nTo access the town channel, use :f."
	icon_state = "cent_headset"
	keyslot = new /obj/item/encryptionkey/headset_montegobay

/obj/item/radio/headset/headset_wndranger
	name = "Ranger radio headset"
	desc = "This is used by the Rangers.\nTo access the town channel, use :f. \nTo access the Ranger channel, use :r."
	icon_state = "mine_headset"
	keyslot = new /obj/item/encryptionkey/headset_wndranger
