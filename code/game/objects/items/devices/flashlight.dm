...
/obj/item/flashlight/floodlight
	name = "floodlight"
	icon_state = "floodlight"
	item_state = "floodlight"
	lefthand_file = 'icons/mob/inhands/equipment/mining_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/equipment/mining_righthand.dmi'
	desc = "A floodlight."
	light_system = MOVABLE_LIGHT
	light_range = 30	// luminosity when on
	light_color = "#ffffff"
	custom_price = PRICE_CHEAP
	anchored = TRUE

/obj/item/flashlight/floodlight/attackby(obj/item/I, mob/user, params)
...
/obj/item/flashlight/tanningbed
	name = "tanning bed"
	icon_state = "tanningbed"
	item_state = "tanningbed"
	desc = "A tanning bed."
	light_system = MOVABLE_LIGHT
