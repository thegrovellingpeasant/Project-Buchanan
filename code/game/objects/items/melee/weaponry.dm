...
/obj/item/cane/cletuspoggcane
	name = "wooden cane"
	desc = "A simple wooden cane, good for thwacking overcurious hands."
	icon = 'icons/obj/items_and_weapons.dmi'
	icon_state = "cletuspoggcane"
	item_state = "cletuspoggcane"
	lefthand_file = 'icons/mob/inhands/weapons/melee_lefthand.dmi'
	righthand_file = 'icons/mob/inhands/weapons/melee_righthand.dmi'
	force = 5
	throwforce = 5
	...
	attack_verb = list("bludgeoned", "thrashed", "walloped", "thwacked", "disciplined", "spared")
