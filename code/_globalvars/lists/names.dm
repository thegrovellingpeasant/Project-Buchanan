...
GLOBAL_LIST_INIT(wright_surname, world.file2list("strings/names/wright_surname.txt"))
GLOBAL_LIST_INIT(bishop_surname, world.file2list("strings/names/bishop_surname.txt"))
