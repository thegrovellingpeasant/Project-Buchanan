...
/datum/controller/subsystem/blackbox/proc/LogBroadcast(freq)
	...
	switch(freq)
		...
		if(FREQ_LDS)
			record_feedback("tally", "radio_usage", 1, "lds")
		if(FREQ_USPS)
			record_feedback("tally", "radio_usage", 1, "usps")
		if(FREQ_MONTEGOBAY)
			record_feedback("tally", "radio_usage", 1, "montegobay")
		if(FREQ_WND)
			record_feedback("tally", "radio_usage", 1, "wnd")
		if(FREQ_EIGHTIES)
			record_feedback("tally", "radio_usage", 1, "eighties")
		if(FREQ_EIGHTIESB)
			record_feedback("tally", "radio_usage", 1, "eightiesb")
		if(FREQ_EIGHTIESR)
			record_feedback("tally", "radio_usage", 1, "eightiesr")
		if(FREQ_SALVATORES)
		...
		if(FREQ_VANGRAFFS)
			record_feedback("tally", "radio_usage", 1, "vangraffs")
		if(FREQ_NRPD)
			record_feedback("tally", "radio_usage", 1, "nrpd")
		if(FREQ_NCRCF)
			record_feedback("tally", "radio_usage", 1, "ncrcf")
		if(FREQ_GOVERNMENT)
			record_feedback("tally", "radio_usage", 1, "government")
		else
