...
/datum/gear/suit/labgoat
	name = "Double-Breasted Labcoat"
...
/datum/gear/suit/whitesuit
	name = "white suit jacket"
	path = /obj/item/clothing/suit/toggle/lawyer/white
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 2

/datum/gear/suit/charcoalsuit
	name = "charcoal suit jacket"
	path = /obj/item/clothing/suit/charcoalsuit
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 2

/datum/gear/suit/navysuit
	name = "navy suit jacket"
	path = /obj/item/clothing/suit/navysuit
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 2

/datum/gear/suit/burgundysuit
	name = "burgundy suit jacket"
	path = /obj/item/clothing/suit/burgundysuit
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 2

/datum/gear/suit/checkeredsuit
	name = "checkered suit jacket"
	path = /obj/item/clothing/suit/checkeredsuit
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 2

/datum/gear/suit/victoriantailcoat
	name = "tail coat"
	path = /obj/item/clothing/suit/victoriantailcoat
	subcategory = LOADOUT_SUBCATEGORY_SUIT_JACKETS
	cost = 3
